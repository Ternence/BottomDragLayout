package com.tern.ui.bottomdraglayout;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                mPanelHeight = ta.getDimensionPixelSize(R.styleable.SlidingUpPanelLayout_dragPanelHeight, -1);

                mDragViewResId = ta.getResourceId(R.styleable.SlidingUpPanelLayout_dragDragView, -1);
                mScrollableViewResId = ta.getResourceId(R.styleable.SlidingUpPanelLayout_dragScrollableView, -1);

                mOverlayContent = ta.getBoolean(R.styleable.SlidingUpPanelLayout_dragOverlay, DEFAULT_OVERLAY_FLAG);
                mClipPanel = ta.getBoolean(R.styleable.SlidingUpPanelLayout_dragClipPanel, DEFAULT_CLIP_PANEL_FLAG);

                //// TODO: 16/3/15 del
                mAnchorPoint = ta.getFloat(R.styleable.SlidingUpPanelLayout_dragAnchorPoint, DEFAULT_ANCHOR_POINT);

                mSlideState = PanelState.values()[ta.getInt(R.styleable.SlidingUpPanelLayout_dragInitialState, DEFAULT_SLIDE_STATE.ordinal())];
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child == mMainView) {
                ...
                // See https://github.com/drag/AndroidSlidingUpPanel/issues/412.
                height -= lp.topMargin;
            }
